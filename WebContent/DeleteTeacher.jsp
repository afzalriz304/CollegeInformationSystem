...
<div class="container-fluid">
    <div class="well">
        <form action="DeleteTeacher" method="post">
            ...
            <label class="control-label col-sm-4" for="rollno"><h4>ENTER THE ID : </h4></label>

                <div class="col-sm-6">
                <input type="text"  class="form-control" id="rollno" name="id" placeholder="enter the id...">
                </div>
...
<div class="container-fluid text-center">
	...
	<a href="AdminTeacher.jsp" class="btn btn-info">GO BACK</a>
</div>
</section>
</body>
</html>