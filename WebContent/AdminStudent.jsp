...
<div class="container-fluid text-center rowCss">
    ...
    <div class="row">
        <div class="col-sm-3">
            <a  href="RegisterStudent.jsp" class="btn btn-lg btn-default">ADD A STUDENT</a><br>
            <p>(Add the Student Data...)</p>
        </div>

        <div class="col-sm-3">
            <a href="DeleteStudent.jsp" class="btn btn-lg btn-danger">DELETE STUDENTS</a><br>
            <p>(Delete the Student Data)</p>
        </div>
        
        <div class="col-sm-3">
            <a href="viewstudent" class="btn btn-lg btn-primary">VIEW STUDENTS</a><br>
            <p>(View the Student Data)</p>
        </div>

        <div class="col-sm-3">
            <a href="UpdateStudent.jsp" class="btn btn-lg btn-info">UPDATE DATA</a><br>
            <p>(Update the student data)</p>
        </div>
    </div>
</div>
</body>
